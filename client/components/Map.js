...
function Map() {
  ...
  const trainStyle = isSelected ? (feature) => {
  ...
  return (
    <div>
      ...
      <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/e/eb/NYCS-bull-trans-1-Std.svg/500px-NYCS-bull-trans-1-Std.svg.png" onClick={() => {
        isSelected = !isSelected
        console.log(`flipped isSelected to ${isSelected}`)
      }}/>
